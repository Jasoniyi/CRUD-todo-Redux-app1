...
import { deleteTodo, toggleTodo, setVisibilityFilter } from "./action";
import { SHOW_ALL, SHOW_COMPLETED, SHOW_ACTIVE } from "./action";
  ...
  render() {
    ...
    return (
      <div className="col-lg-10 offset-lg-1 col-md-10 col-sm-12 col-xs-12">
        ...
        {this.props.TodoReducer.length !== 0 ? (
          <table
          ...
          >
            ...
            <tbody>
              {this.props.TodoReducer.map(todo => (
                <tr key={todo.id}>
                  <td
                    style={{
...
const mapStateToProps = state => {
  ...
  return {
    TodoReducer: getVisibleTodos(state.TodoReducer, state.visibilityFilter),
